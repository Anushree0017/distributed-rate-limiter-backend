...
def create_redis_pool() -> ConnectionPool:
    return ConnectionPool.from_url(
        ...
        max_connections=settings.get_redis_max_connections(),
        socket_timeout=settings.get_redis_socket_timeout_seconds(),
        socket_connect_timeout=settings.get_redis_socket_connect_timeout_seconds(),
    )
